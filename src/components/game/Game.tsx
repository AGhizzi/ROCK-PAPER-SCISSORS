...
import { Choice, GameResult, GameProps, Gender } from '../../types/game';
...
export function Game({ onComplete, gender, onGameHistory }: ExtendedGameProps) {
  const [gameState, setGameState] = useState({
    ...
    computerChoice: null as Choice | null,
  ...
  const [lastComputerChoice, setLastComputerChoice] = useState<Choice | undefined>();
